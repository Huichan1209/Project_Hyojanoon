...
//                mMainImage.setImageBitmap(bitmap);
    ...
    private static class LableDetectionTask extends AsyncTask<Object, Void, String> {
        private final WeakReference<TrainingActivity> mActivityWeakReference;
        private Vision.Images.Annotate mRequest;

        LableDetectionTask(TrainingActivity activity, Vision.Images.Annotate annotate) {
        ...
        protected void onPostExecute(String result) {
            TrainingActivity activity = mActivityWeakReference.get();
