...
public class SecondLearnActivity extends AppCompatActivity {

    ImageView[] brailles;
    TextView tvChar;
    TextToSpeech tts;
    LinearLayout secLearnLinear;
    Braille braille;
    char[] chars = {'ㅏ','ㅑ', 'ㅓ', 'ㅕ', 'ㅗ', 'ㅛ', 'ㅜ', 'ㅠ', 'ㅡ', 'ㅣ', 'ㅐ', 'ㅔ', 'ㅚ', 'ㅘ', 'ㅝ', 'ㅢ', 'ㅖ'};
    int currentChar = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_second_learn);
        settingVars();
    ...
    private void settingVars(){
        ...
        brailles[0] = (ImageView) findViewById(R.id.second_learn_braille1);
        brailles[1] = (ImageView) findViewById(R.id.second_learn_braille2);
        brailles[2] = (ImageView) findViewById(R.id.second_learn_braille3);
        brailles[3] = (ImageView) findViewById(R.id.second_learn_braille4);
        brailles[4] = (ImageView) findViewById(R.id.second_learn_braille5);
        brailles[5] = (ImageView) findViewById(R.id.second_learn_braille6);
...
//        setBlueTooth();
        ...
        secLearnLinear = (LinearLayout) findViewById(R.id.secondLearnLinear);
        secLearnLinear.setOnTouchListener(new OnSwipeTouchListener(SecondLearnActivity.this){
        ...
        tvChar = (TextView) findViewById(R.id.tvChar_sec);
    }
    ...
    private void updateChange(){
        ...
        char brailleCode = braille.getBrailleCode(Braille.SECOND_SOUND, chars[currentChar]);
