...
public class FirstLearnActivity extends AppCompatActivity {
    ImageView[] brailles;
    TextView tvChar;
    TextToSpeech tts;
    LinearLayout firtLearnLinear;
    Braille braille;
    char[] chars = {'ㄱ','ㄴ', 'ㄷ', 'ㄹ', 'ㅁ', 'ㅂ', 'ㅅ', 'ㅇ', 'ㅈ', 'ㅊ', 'ㅋ', 'ㅌ', 'ㅍ', 'ㅎ'};
    int currentChar = 0;
    ...
    private void settingVars(){
        ...
        brailles[0] = (ImageView) findViewById(R.id.first_learn_braille1);
        brailles[1] = (ImageView) findViewById(R.id.first_learn_braille2);
        brailles[2] = (ImageView) findViewById(R.id.first_learn_braille3);
        brailles[3] = (ImageView) findViewById(R.id.first_learn_braille4);
        brailles[4] = (ImageView) findViewById(R.id.first_learn_braille5);
        brailles[5] = (ImageView) findViewById(R.id.first_learn_braille6);
...
//        setBlueTooth();
        ...
        firtLearnLinear = (LinearLayout) findViewById(R.id.firstLearnLinear);
        firtLearnLinear.setOnTouchListener(new OnSwipeTouchListener(getApplicationContext()){
        ...
        tvChar = (TextView) findViewById(R.id.tvChar_fir);
    }
    ...
    private void updateChange(){
        ...
        char brailleCode = braille.getBrailleCode(Braille.FIRST_SOUND, chars[currentChar]);
